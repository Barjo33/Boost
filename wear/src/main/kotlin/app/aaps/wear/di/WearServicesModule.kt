...
import app.aaps.wear.complications.DynIsfComplication
...
import app.aaps.wear.complications.SgvRangedComplication
...
abstract class WearServicesModule {
    ...
    @ContributesAndroidInjector abstract fun contributesDynIsfComplication(): DynIsfComplication
    ...
    @ContributesAndroidInjector abstract fun contributesSgvRangedComplication(): SgvRangedComplication
