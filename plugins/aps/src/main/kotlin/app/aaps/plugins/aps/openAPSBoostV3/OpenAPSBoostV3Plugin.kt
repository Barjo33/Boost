...
open class OpenAPSBoostV3Plugin @Inject constructor(
    ...
    override fun addPreferenceScreen(preferenceManager: PreferenceManager, parent: PreferenceScreen, context: Context, requiredKey: String?) {
        ...
        boostScreen.key = "openapsboostv3_settings"
        boostScreen.title = rh.gs(R.string.openaps_boost_v3)
        ...
        boostScreen.apply {
            ...
            // ── 2. Boost Controls ────────────────────────────────────────
            addPreference(preferenceManager.createPreferenceScreen(context).apply {
                key = "boost_controls_settings"
                title = rh.gs(R.string.boost_settings_boost_controls)
