...
class DetermineBasalBoostV2 @Inject constructor(
    ...
    fun determine_basal(
        ...
        // Expose V2's computed minGuardBG on RT for V5 silent shadow's hard-gate check.
        ...
        if (iob_data.iob > max_iob) {
            ...
            // T3 and T4 fire normally when their conditions are met. See V1 for
            // the full rationale (kept in sync).
            ...
            if (microBolusAllowed && enableSMB && bg > threshold) {
                ...
                // Existing !fastCarbRebound gate preserved.
                else if (!mlTierDowngrade && !g3HoldActive && !fastCarbRebound && bg > 110 && bg < 181 && glucose_status.delta > 3 && delta_accl > 0 && eventualBG > target_bg && iob_data.iob < boostMaxIOB && boostActive) {
                ...
                // Layer B: !mlTierDowngrade gate added. Layer C: !g3HoldActive gate added.
                // Existing !fastCarbRebound gate preserved.
                else if (!mlTierDowngrade && !g3HoldActive && !fastCarbRebound && delta_accl > 25 && glucose_status.delta > 4 && bg > 110 && iob_data.iob < boostMaxIOB && boostActive && eventualBG > target_bg) {
