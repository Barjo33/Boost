...
Everything above is the V5 dosing core. V6 is what you get when you wrap that core in *context* — and this is where the step-count work from the earlier article grows up.
