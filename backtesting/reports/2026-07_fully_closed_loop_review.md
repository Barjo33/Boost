...
## What "fully closed loop" means here, and how we can judge it
...
figure is 96–100%. A couple of people announce some meals; the rest announce essentially
...
sat at a mean **Time in Range (70–180 mg/dL) of 87% (±7)** and **Time in Normoglycaemia
(63–140 mg/dL, TING) of 72% (±11)**, with **time below 54 mg/dL of just 0.62%** — all of
...
delivers, achieved by someone who tells the loop nothing about their meals. *(SOLID —
descriptive cohort measurement.)*
...
delta-based confirmation by around 5–15 minutes on this cohort's data. The loop is not blind
...
insulin, but at the onset of these lows the median insulin on board was already **0.48 U** —
there is frequently nothing left to withdraw. Basal is at zero; a bolus already given cannot
...
19% [17–21]; 2–5 h: 20% [18–22]), only easing toward baseline after that (5–8 h: 16%
[15–18]). Reactive control is structurally blind to this tail: the insulin responsible was
...
we measure at **20–39%** in that specific context. The loop is not badly tuned here; it is
...
## What actually drives the insulin response
